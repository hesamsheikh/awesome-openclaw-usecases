...
| [Linux Perf Performance Analysis](usecases/linux-perf-analysis.md) | Profile and optimize application performance using Linux perf — CPU hotspots, syscall overhead, bottleneck diagnosis. |
