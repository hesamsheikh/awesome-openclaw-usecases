...
| [Skill Library Taxonomy Audit](usecases/skill-library-taxonomy-audit.md) | Turn a growing OpenClaw skill library into an interactive architecture report — layers, dependencies, routing conflicts, duplicates, violations, and missing abstractions. |
