...
| [Multi-Agent CFO Research Suite](usecases/multi-agent-cfo-research-suite.md) | Run CHP-hardened multi-agent financial research — SEC deep dives, forecasts, and board-ready memos with auditable consensus. |
| [Swarm Intelligence Orchestrator](usecases/swarm-intelligence-orchestrator.md) | Orchestrate specialized agents via stigmergic coordination, adversarial consensus (CHP), and PARL performance learning. |
