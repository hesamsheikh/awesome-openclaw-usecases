...
| [KatClaw — Native macOS GUI](usecases/katclaw-macos-gui.md) | One-click macOS app that installs and manages OpenClaw with a full GUI — AI provider setup, Telegram connection, security modes (Conservative/Moderate/Full), skill management with VirusTotal badges, and auto-updates. No Terminal needed. |
