...
| [Intelligent Memory-Driven Assistant](usecases/intelligent-memory-assistant.md) | Personal assistant with intelligent memory (core/daily/decision), auto intent detection, and context-aware responses that maintain consistency over time. |
