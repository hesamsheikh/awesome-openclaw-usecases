...
| [Sub-Agent Live Progress Reporting](usecases/subagent-live-progress-reporting.md) | Get real-time Telegram/Discord updates from sub-agents as they work — start, progress, and completion messages without exposing personal chat IDs in shared configs. |
