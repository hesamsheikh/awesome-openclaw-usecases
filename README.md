...
| Name | Description |
|------|-------------|
| [Domain Name Registration](usecases/domain-name-registration.md) | Let your agent check availability and register ICANN domains programmatically — no browser, no CAPTCHA, no manual forms. |
